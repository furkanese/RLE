...
# gray_row_encoded = image_codec.encode_image(color_gray[0], g_row, g_col, 'row')
# np.savetxt('biber_gray_encode_row.txt', gray_row_encoded, fmt='%d',newline=' ')
#
# gray_col_encoded = image_codec.encode_image(color_gray[0], g_row, g_col, 'col')
...
bw_row_encoded = image_codec.encode_image(color_bw[0], bw_row, bw_col, 'row')
print(np.shape(bw_row_encoded))
np.savetxt('biber_bw_encode_row.txt', bw_row_encoded, fmt='%d',newline=' ')

bw_col_encoded = image_codec.encode_image(color_bw[0], bw_row, bw_col, 'col')
